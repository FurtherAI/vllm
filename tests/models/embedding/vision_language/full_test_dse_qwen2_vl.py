...
def _run_test(
    ...
    *,
    ...
    with vllm_runner(model, task="embedding", dtype=dtype,
                     enforce_eager=True, max_model_len=8192) as vllm_model:
        texts = [
    ...
    for text, image in zip(input_texts, input_images):
        ...
        vllm_api_outputs.append(response_json["data"][0]["embedding"])
    ...
    check_embeddings_close(
        ...
        embeddings_1_lst=vllm_api_outputs,
        name_0="hf",
        name_1="vllm_api",
    )
    check_embeddings_close(
